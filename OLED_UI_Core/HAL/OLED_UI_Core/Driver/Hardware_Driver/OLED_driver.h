...
#define OLED_RES_Clr() (HAL_GPIO_WritePin(OLED_RST_GPIO_Port, OLED_RST_Pin, 0)) // 复位 DC (将DC引脚拉低)
#define OLED_RES_Set() (HAL_GPIO_WritePin(OLED_RST_GPIO_Port, OLED_RST_Pin, 1)) // 置位 DC (将DC引脚拉高)
